...
// ApplicationInboundProtocolsOidcRegenerateSecretModel is the Terraform model for application_inbound_protocols_oidc_regenerate_secret.
type ApplicationInboundProtocolsOidcRegenerateSecretModel struct {
