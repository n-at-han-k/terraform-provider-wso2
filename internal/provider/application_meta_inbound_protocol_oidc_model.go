...
// ApplicationMetaInboundProtocolOidcModel is the Terraform model for application_meta_inbound_protocol_oidc.
type ApplicationMetaInboundProtocolOidcModel struct {
...
func (m *ApplicationMetaInboundProtocolOidcModel) FromClientModel(c *client.OidcMetaData) {
