...
// OrganizationsMetadataModel is the Terraform model for organizations_metadata.
type OrganizationsMetadataModel struct {
...
func (m *OrganizationsMetadataModel) FromClientModel(c *client.OrganizationMetadata) {
	...
	if encoded, err := json.Marshal(c.Permissions); err == nil {
		if m.Permissions.IsNull() || m.Permissions.IsUnknown() ||
			!jsonSupersetOf(string(encoded), m.Permissions.ValueString()) {
	...
	if encoded, err := json.Marshal(c.DiscoveryAttributes); err == nil {
		if m.DiscoveryAttributes.IsNull() || m.DiscoveryAttributes.IsUnknown() ||
			!jsonSupersetOf(string(encoded), m.DiscoveryAttributes.ValueString()) {
