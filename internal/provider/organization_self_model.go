...
// OrganizationSelfModel is the Terraform model for organization_self.
type OrganizationSelfModel struct {
...
func (m *OrganizationSelfModel) FromClientModel(c *client.OrganizationResponse) {
